...
#define DIN 12 //pin 12 is connected to the DIN 
#define CLK 11 //pin 11 is connected to the CLK 
#define LOAD 10 //pin 10 is connected to LOAD 
...
////////////////// Rockets
#define MAX_NUMBER_OF_ROCKETS 20
...
int findRocketID();
bool isRocketNone(Rocket);
void deleteRocket(int);
...
class Spaceship {
  public:
    ...
    int score = 0; /// NOT USED, FUTURE IN WORK
...
////////////////// Meteor
#define MAX_NUMBER_OF_METEORS 64
...
int gameSpeed = 500; /// NOT USED, FUTURE IN WORK

void drawGrid (byte *);
void drawSpaceship (int);
void drawRockets();
void drawMeteors();
